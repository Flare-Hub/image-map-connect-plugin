 ...
 *
 * @param {object} props
 * @param {import('@wordpress/core-data').EntityRecord} props.marker Selected marker.
 ...
 */
export default function MarkerLifecycle({ marker, save, delete: delMarker, listQuery }) {
	...
	return <LifeCycleButtons
		...
		onSave={handleSave}
		confirmDeleteText={__('Are you sure you want to delete this marker?', 'flare')
			+ ' ' + (marker.type === 'marker'
				? __('This will remove the marker and all its content.', 'flare')
				: __('This will remove the marker. The related post will not be removed', 'flare'))}
	/>
}
