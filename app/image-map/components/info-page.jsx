			...
			<CardBody>
				<div className="col-9">
					<div className={ cls.content }>
						...
						<p>
							{ __(
								'Image Map Connect allows you to add any image to your website as an image map, and make it interactive.',
								'flare-imc'
							) + ' ' }
							{ __( 'On the image map you can:', 'flare-imc' ) }
						</p>
						<ul>
							<li>
								{ __(
							...
							<li>
								{ __( 'Switch between layers', 'flare-imc' ) }
							</li>
						...
						<p>
							{ __(
								'The Admin page is the page you are currently on and has 4 tabs: Maps, Layers, Markers and Info.',
								'flare-imc'
							) }
						</p>
						<h4>{ __( 'Maps Tab', 'flare-imc' ) }</h4>
						<p>
							{ __(
						...
						<p>
							{ __( 'Image map details include:', 'flare-imc' ) }
						</p>
						<ul>
						...
						<h4>{ __( 'Markers Tab', 'flare-imc' ) }</h4>
						<p>
							{ __(
						...
						<ul>
							...
							<li>{ __( 'Rich text content.', 'flare-imc' ) }</li>
							<li>{ __( 'A featured image.', 'flare-imc' ) }</li>
						</ul>
						<h4>{ __( 'Info Tab', 'flare-imc' ) }</h4>
						<p>
							{ __(
						...
						<p>
							{ __(
								'The initial layer, zoom level and position in the public UI is based on the selected layer, position and zoom level defined in the block editor. To fix this position, press the lock icon on the map.',
								'flare-imc'
							) }
						</p>
						<h4>{ __( 'Filtering Markers', 'flare-imc' ) }</h4>
						<p>
							{ __(
						...
						<p>
							{ __(
								'To manage the plugin and track these tickets we make use of Github. Any issues or request can be reported',
								'flare-imc'
							) + ' ' }
							<a
							...
							{ ' ' +
								__(
									'Please just make sure to search the existing issues and only report new ones.',
									'flare-imc'
								) }
						</p>
						<h2 id="author">
						...
						<p>
							{ __(
								'We are a couple who enjoy working with solutions that smoothen user experience and processes, and offer informative and useful content.',
								'flare-imc'
							) }
							{ __( 'Through our company', 'flare-imc' ) + ' ' }
							<a
							...
							{ ' ' +
								__(
									'we help organisations to design and build intuitive digital products.',
									'flare-imc'
								) }
						</p>
					</div>
